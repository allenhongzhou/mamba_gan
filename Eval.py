...
patch_embedding.load_state_dict((torch.load(args.patch_embedding)))
patch_decoder.load_state_dict((torch.load(args.patch_decoder)))
...
decoder.to(device)
mamba.to(device)
patch_embedding.to(device)
patch_decoder.to(device)
